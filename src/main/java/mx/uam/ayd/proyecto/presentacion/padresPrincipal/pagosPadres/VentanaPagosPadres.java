...
@Component
public class VentanaPagosPadres {

    private Stage stage;
    private ControlPagosPadres control;
    ...
    public void muestra(ControlPagosPadres control) {
        this.control = control;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/PagosPadres.fxml"));
