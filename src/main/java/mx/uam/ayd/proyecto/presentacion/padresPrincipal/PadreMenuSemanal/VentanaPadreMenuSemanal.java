...
public class VentanaPadreMenuSemanal {
    ...
    private Stage stage;
    private ControlPadreMenuSemanal control;
     ...
     */
    public void muestra(ControlPadreMenuSemanal control, Map<String, String[]> menuPorDia) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/VentanaPadreMenuSemanal.fxml"));
