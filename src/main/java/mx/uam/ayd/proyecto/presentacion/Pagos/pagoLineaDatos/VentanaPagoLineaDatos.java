package mx.uam.ayd.proyecto.presentacion.Pagos.pagoLineaDatos;
...
@Component
public class VentanaPagoLineaDatos {

    private Stage stage;
    private ControlPagoLineaDatos control;
     ...
     */
    public void muestra(ControlPagoLineaDatos control, int total) {
        this.control = control;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/PagoLineaTarjeta.fxml"));
